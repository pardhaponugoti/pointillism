...
titles[3] = 'Georges Seurat - A Sunday on La Grande Jatte';
...
titles[8] = 'Arne Niklas Jansson - Touched by His Noodly Appendage';
...
void mouseReleased() {
  ...
  fill(0, 0, 0, 255);
  rect(window.innerWidth * 2/3, window.innerHeight * 3/4 + 8, 300, 15)
